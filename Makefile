...
HEADER += check_program_header.h
HEADER += parse_program_header.h
HEADER += utils.h
# HEADER += parse_section.h
# HEADER += parse_symbol.h
# HEADER += parse_symbol_32.h
# HEADER += parse_symbol_64.h
vpath %.h $(INC_DIR)
...
SRCS += nm.c
SRCS += parse_header.c
# SRCS += parse_header_2.c
SRCS += check_program_header.c
SRCS += parse_program_header.c
SRCS += elf32.c
SRCS += elf64.c
SRCS += utils.c
